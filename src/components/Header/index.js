        ...
        <StyledAppBar ref={headerRef} position="static">
            <StyledToolbar>
                ...
                <Group>
                    ...
                    <StyledIconButton edge="end" color="inherit" aria-label="menu" onClick={toggleMenu}>
                        {isOpenMenu ? <ClearIcon /> : <MenuIcon />}
                    </StyledIconButton>
                    <StyledMenu
                    ...
                    >
                        <StyledMenuItem>
                            <ListItemText primary="Обучающее видео" />
                        </StyledMenuItem>
                        <StyledMenuItem>
